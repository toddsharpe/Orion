...
namespace Orion.Tests.Golden
{
	...
	internal static class Tool
	{
		...
		//A directory for cl.exe's /Fo and /Fe, separator doubled: Windows reads `\"` as an escaped quote, so /Fo:"C:\dir\" never closes.
		internal static string QuotedDir(string dir) =>
